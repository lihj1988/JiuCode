...
import com.jiuwang.buyer.adapter.GoodsOrderListAdapter;
import com.jiuwang.buyer.base.MyApplication;
import com.jiuwang.buyer.bean.OrderBean;
import com.jiuwang.buyer.util.AndroidUtil;
...
public class OrderEvaluateActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        mAdapter = new GoodsOrderListAdapter(mApplication, mArrayList);
    ...
    private void setImage() {
        ...
        for (int i = 0; i < 5; i++) {
            mImageView[i].setImageResource(R.drawable.ic_transparent);
        ...
        if (imageVector.size() < 5) {
            mImageView[imageVector.size()].setImageResource(R.drawable.ic_add_img);
        }
...
//                            total += "，共 <font color='#FF5001'>￥ " + money + "</font> 元";
