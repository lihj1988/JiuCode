package com.jiuwang.buyer.dialog;
...
public class DoubleDatePickerDialog extends AlertDialog implements
	...
	public DoubleDatePickerDialog(Context context, int theme,
		...
		resizePikcer(mDatePicker_start);// 调整datepicker大小
		resizePikcer(mDatePicker_end);// 调整datepicker大小
	...
	private void resizeNumberPicker(NumberPicker np) {
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(155,
	 ...
	 * 调整numberpicker大小
	 */
	private void resizeNumberPickerMonth(NumberPicker np) {
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(83,
				LayoutParams.WRAP_CONTENT);
		params.setMargins(0, 0, 0, 0);
		np.setLayoutParams(params);
	}
