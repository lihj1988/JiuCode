...
//            JSONArray jsonArray = new JSONArray(orderBean.get("order_list"));
//            ArrayList<HashMap<String, String>> goodsArrayList = new ArrayList<>();
//            final HashMap<String, String> orderHashMap = new HashMap<>(TextUtil.jsonObjectToHashMap(jsonArray.get(0).toString()));
//
//            jsonArray = new JSONArray(orderHashMap.get("extend_order_goods"));
...
//            }
            ...
            holder.storeTextView.setText(orderBean.getStore_name());
            holder.stateTextView.setText(orderBean.getStore_desc());

            String total = "共 <font color='#FF5001'>" + orderBean.getOrder_count() + "</font> 件商品";
            total += "，共 <font color='#FF5001'>￥ " +  orderBean.getOrder_amount() + "</font> 元";
