...
public class LocationService {
	 ...
	 */
	public LocationService(Context locationContext,boolean b){
		synchronized (objLock) {
			if(client == null){
				client = new LocationClient(locationContext);				
				client.setLocOption(getDefaultLocationClientOption(b));
			}
		}
	}
	...
	public void unregisterListener(BDAbstractLocationListener mListener){
		if(mListener != null){
	 ...
	 */
	public LocationClientOption getDefaultLocationClientOption(boolean b ){
		if(mOption == null){
	...
	public void enableLocInForeground(Notification notification) {
		...
		client.enableLocInForeground(110, notification);
