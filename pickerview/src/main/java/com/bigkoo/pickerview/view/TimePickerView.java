...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            Button btempty = (Button) findViewById(R.id.btempty);

            btnSubmit.setTag(TAG_SUBMIT);
            btnCancel.setTag(TAG_CANCEL);
            btempty.setTag(TAG_EMPTY);
            ...
            btempty.setText(TextUtils.isEmpty(mPickerOptions.textContentEmpty) ? "清空" : mPickerOptions.textContentEmpty);//默认为清空
            ...
            btempty.setTextColor(mPickerOptions.textColorempty);
            ...
            btempty.setTextSize(mPickerOptions.textSizeSubmitCancel);
    ...
    public void returnEnpty() {
        if (mPickerOptions.timeSelectListener != null) {
            try {
                Date date = WheelTime.dateFormat.parse(wheelTime.getTime());
                mPickerOptions.timeSelectListener.onTimeempty(clickView);
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }
